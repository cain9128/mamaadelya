...
const plans = [
  ...
  { id: 'tokens3', name: '3 токена', price: 270, credits: 3, period: '/ разово', features: ['3 генерации (токена)', 'Зачисляются на баланс', 'Без срока действия', 'Без подписки'], featured: false, cta: 'Купить' },
        ...
        <section className="container section" id="faq">
          ...
          <div className="faq-list">
            ...
            <details className="faq-item">
              ...
              <div className="faq-answer">
                <p>Токены из разового пакета «3 токена» за 270 ₽ не имеют срока действия и не сгорают через 30 дней или при окончании подписки.</p>
                <p>Токены, начисленные по ежемесячной подписке, действуют в пределах расчётного периода. Если подписка не продлена вовремя, оставшиеся токены подписки сгорают.</p>
